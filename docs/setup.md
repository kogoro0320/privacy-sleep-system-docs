...
配置した <u>**PrivacySleepSystem**</u> を選択し、Inspector より Transform の <u>**Position Y**</u> を設定してください。<br>
床の高さが 0 のワールドでは、SleepArea を床に少しめり込ませる前提のため **Y = 0** にします。<br>
床の高さが 0 ではない場合、床の高さに合わせて Y を調整してください。

![設定画面](images/setup_03-01.png)

!!! warning "注意"
    デフォルトでは、Y を 0 にした場合に、睡眠エリア( SleepArea )の下部が少し床にめり込むように調整しています。（位置ずれによる検出漏れ防止のため）
...
!!! warning "注意"
    SleepArea 内にある各オブジェクトの Transform や Box Collider の範囲は個別に調整せず、できるだけ SleepArea の Transform のみを調整するようにしてください。<br>
...
2. <u>**OverlayTeleportFade**</u> のTransformを、SleepArea と TeleportPoint の両方が<u>**Box内に入るように**</u>調整してください。
