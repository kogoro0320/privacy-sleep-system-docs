...
!!! tips "推奨設定"
    SleepArea の比率を 1:1:1 以外に変更すると、カーテンのテクスチャ比率が崩れることがあります。<br>
    必要に応じて、各カーテンの Material の Tiling を調整してください。<br>
    <br>
    また、4枚のカーテンは初期状態で同じ Material を共有しています。<br>
    前後左右で異なる比率にしたい場合は、Material を複製して個別に設定してください。
